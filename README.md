...
> View the live project at: [https://sahedalomsumit.com/salah-tracker](https://sahedalomsumit.com/salah-tracker)
...
- **SEO**: Custom hooks for dynamic metadata management.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/sahedalomsumit/salah-tracker-web.git
   ```
2. Navigate to the project directory:
   ```bash
   cd salah-tracker-web
   ```
...
Developed with ❤️ by [Sahed Alom Sumit](https://github.com/sahedalomsumit)
